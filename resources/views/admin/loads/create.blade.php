                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="job_description" id="job_description_select"
                                                    class="form-control" onchange="toggleOtherJobDescription()">
                                                    <option value="Delivery Directi"
                                                        {{ old('job_description') == 'Delivery Directi' ? 'selected' : '' }}>
                                                        Delivery Directi</option>
                                                    <option value="Pickup Only"
                                                        {{ old('job_description') == 'Pickup Only' ? 'selected' : '' }}>
                                                        Pickup Only</option>
                                                    <option value="Warehouse Transfer"
                                                        {{ old('job_description') == 'Warehouse Transfer' ? 'selected' : '' }}>
                                                        Warehouse Transfer</option>
                                                    <option value="Line Haul"
                                                        {{ old('job_description') == 'Line Haul' ? 'selected' : '' }}>Line
                                                        Haul</option>
                                                    <option value="Other"
                                                        {{ old('job_description') == 'Other' ? 'selected' : '' }}>Other
                                                    </option>
                                                </select>
                                                <input type="text" name="job_description_other"
                                                    id="job_description_other" class="form-control mt-2"
                                                    placeholder="Please specify" style="display: none;"
                                                    value="{{ old('job_description_other') }}">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">Suggested Vehicle</label>
                                                <select name="suggested_vehicle" id="suggested_vehicle_select"
                                                    class="form-control" onchange="toggleOtherSuggestedVehicle()">
                                                    <option value="Truck"
                                                        {{ old('suggested_vehicle') == 'Truck' ? 'selected' : '' }}>Truck
                                                    </option>
                                                    <option value="Van"
                                                        {{ old('suggested_vehicle') == 'Van' ? 'selected' : '' }}>Van
                                                    </option>
                                                    <option value="Trailer"
                                                        {{ old('suggested_vehicle') == 'Trailer' ? 'selected' : '' }}>
                                                        Trailer</option>
                                                    <option value="Container"
                                                        {{ old('suggested_vehicle') == 'Container' ? 'selected' : '' }}>
                                                        Container</option>
                                                    <option value="Pickup"
                                                        {{ old('suggested_vehicle') == 'Pickup' ? 'selected' : '' }}>Pickup
                                                    </option>
                                                    <option value="Other"
                                                        {{ old('suggested_vehicle') == 'Other' ? 'selected' : '' }}>Other
                                                    </option>
                                                </select>
                                                <input type="text" name="suggested_vehicle_other"
                                                    id="suggested_vehicle_other" class="form-control mt-2"
                                                    placeholder="Please specify" style="display: none;"
                                                    value="{{ old('suggested_vehicle_other') }}">
                                            </div>
                                            @push('scripts')
                                                <script>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <select name="packaging" id="packaging_select" class="form-control"
                                                    onchange="toggleOtherPackaging()">
                                                    <option value="Box"
                                                        {{ old('packaging') == 'Box' ? 'selected' : '' }}>Box</option>
                                                    <option value="Pallet"
                                                        {{ old('packaging') == 'Pallet' ? 'selected' : '' }}>Pallet
                                                    </option>
                                                    <option value="Crate"
                                                        {{ old('packaging') == 'Crate' ? 'selected' : '' }}>Crate</option>
                                                    <option value="Bag"
                                                        {{ old('packaging') == 'Bag' ? 'selected' : '' }}>Bag</option>
                                                    <option value="Drum"
                                                        {{ old('packaging') == 'Drum' ? 'selected' : '' }}>Drum</option>
                                                    <option value="Other"
                                                        {{ old('packaging') == 'Other' ? 'selected' : '' }}>Other</option>
                                                </select>
                                                <input type="text" name="packaging_other" id="packaging_other"
                                                    class="form-control mt-2" placeholder="Please specify"
                                                    style="display: none;" value="{{ old('packaging_other') }}">
                                            </div>
                                            @push('scripts')
                                                <script>
                                                    function toggleOtherJobDescription() {
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <select name="weight_unit" id="weight_unit_select" class="form-control"
                                                    ...
                                                    <option value="kg"
                                                        {{ old('weight_unit') == 'kg' ? 'selected' : '' }}>kg</option>
                                                    <option value="lbs"
                                                        {{ old('weight_unit') == 'lbs' ? 'selected' : '' }}>lbs</option>
                                                    <option value="Other"
                                                        {{ old('weight_unit') == 'Other' ? 'selected' : '' }}>Other
                                                    </option>
                                                </select>
                                                <input type="text" name="weight_unit_other" id="weight_unit_other"
                                                    class="form-control mt-2" placeholder="Please specify"
                                                    style="display: none;" value="{{ old('weight_unit_other') }}">
                                            </div>
                                            @push('scripts')
                                                <script>
                                                    function toggleOtherJobDescription() {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="body_type" id="body_type_select" class="form-control"
                                                    onchange="toggleOtherBodyType()">
                                                    <option value="Flatbed"
                                                        {{ old('body_type') == 'Flatbed' ? 'selected' : '' }}>Flatbed
                                                    </option>
                                                    <option value="Box Truck"
                                                        {{ old('body_type') == 'Box Truck' ? 'selected' : '' }}>Box Truck
                                                    </option>
                                                    <option value="Reefer"
                                                        {{ old('body_type') == 'Reefer' ? 'selected' : '' }}>Reefer
                                                    </option>
                                                    <option value="Tanker"
                                                        {{ old('body_type') == 'Tanker' ? 'selected' : '' }}>Tanker
                                                    </option>
                                                    <option value="Curtainside"
                                                        {{ old('body_type') == 'Curtainside' ? 'selected' : '' }}>
                                                        Curtainside</option>
                                                    <option value="Other"
                                                        {{ old('body_type') == 'Other' ? 'selected' : '' }}>Other</option>
                                                </select>
                                                <input type="text" name="body_type_other" id="body_type_other"
                                                    class="form-control mt-2" placeholder="Please specify"
                                                    style="display: none;" value="{{ old('body_type_other') }}">
                                            </div>
                                            @push('scripts')
                                                <script>
                                                    function toggleOtherJobDescription() {
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="job_type" id="job_type_select" class="form-control"
                                                    onchange="toggleOtherJobType()">
                                                    <option value="Hotshot"
                                                        {{ old('job_type') == 'Hotshot' ? 'selected' : '' }}>Hotshot
                                                    </option>
                                                    <option value="Backload"
                                                        {{ old('job_type') == 'Backload' ? 'selected' : '' }}>Backload
                                                    </option>
                                                    <option value="Other"
                                                        {{ old('job_type') == 'Other' ? 'selected' : '' }}>Other</option>
                                                </select>
                                                <input type="text" name="job_type_other" id="job_type_other"
                                                    class="form-control mt-2" placeholder="Please specify"
                                                    style="display: none;" value="{{ old('job_type_other') }}">
                                            </div>
                                            @push('scripts')
                                                <script>
                                                    function toggleOtherJobDescription() {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <select name="dimension_unit" id="dimension_unit_select"
                                                    class="form-control" onchange="toggleOtherDimensionUnit()">
                                                    <option value="mm"
                                                        {{ old('dimension_unit') == 'mm' ? 'selected' : '' }}>mm</option>
                                                    <option value="cm"
                                                        {{ old('dimension_unit') == 'cm' ? 'selected' : '' }}>cm</option>
                                                    <option value="in"
                                                        {{ old('dimension_unit') == 'in' ? 'selected' : '' }}>in</option>
                                                    <option value="ft"
                                                        {{ old('dimension_unit') == 'ft' ? 'selected' : '' }}>ft</option>
                                                    <option value="Other"
                                                        {{ old('dimension_unit') == 'Other' ? 'selected' : '' }}>Other
                                                    </option>
                                                </select>
                                                <input type="text" name="dimension_unit_other"
                                                    id="dimension_unit_other" class="form-control mt-2"
                                                    placeholder="Please specify" style="display: none;"
                                                    value="{{ old('dimension_unit_other') }}">
                                            </div>
                                            @push('scripts')
                                                <script>
                                                    function toggleOtherJobDescription() {
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="status" class="form-control">
                                                    ...
                                                    <option value="assigned"
                                                        {{ old('status') == 'assigned' ? 'selected' : '' }}>Assigned
                                                    </option>
                                                    <option value="in_progress"
                                                        {{ old('status') == 'in_progress' ? 'selected' : '' }}>In Progress
                                                    </option>
                                                    <option value="picked_up"
                                                        {{ old('status') == 'picked_up' ? 'selected' : '' }}>Picked Up
                                                    </option>
                                        ...
                                        <div class="row">
                                            {{-- <div class="col-md-4 mb-3">
                                                ...
                                                <input type="number" step="any" name="distance_miles"
                                                    class="form-control" value="{{ old('distance_miles') }}">
                                            </div> --}}
                                            {{-- <div class="col-md-4 mb-3">
                                                <label class="form-label">Rate per km</label>
                                                <input type="number" step="any" name="rate_per_km"
                                                    class="form-control" value="{{ old('rate_per_km') }}">
                                            </div> --}}
                                            {{-- <div class="col-md-4 mb-3">
                                                <label class="form-label">Rate per mile</label>
                                                <input type="number" step="any" name="rate_per_mile"
                                                    class="form-control" value="{{ old('rate_per_mile') }}">
                                            </div> --}}
                                        </div>
                                        <div class="row">
                                            {{-- <div class="col-md-6 mb-3">
                                ...
                                <div class="card mb-4 border-secondary">
                                    <div class="card-header bg-secondary text-white">
                                        <h5 class="mb-0"><i class="fas fa-calendar-check"></i> Assignment & Completion
                                        </h5>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
