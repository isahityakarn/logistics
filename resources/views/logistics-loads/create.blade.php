...
@section('title', 'Create Logistics Job')
@section('page-title', 'Create New Logistics Job')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('pickup_phone') is-invalid @enderror" 
                                       id="pickup_phone" name="pickup_phone" value="{{ old('pickup_phone') }}">
                                @error('pickup_phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('pickup_company') is-invalid @enderror" 
                                       id="pickup_company" name="pickup_company" value="{{ old('pickup_company') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('pickup_additional_info') is-invalid @enderror" 
                                          id="pickup_additional_info" name="pickup_additional_info" rows="3">{{ old('pickup_additional_info') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.00000001" class="form-control @error('pickup_latitude') is-invalid @enderror" 
                                               id="pickup_latitude" name="pickup_latitude" value="{{ old('pickup_latitude') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control @error('pickup_date_time_from') is-invalid @enderror" 
                                               id="pickup_date_time_from" name="pickup_date_time_from" value="{{ old('pickup_date_time_from') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control @error('pickup_date_time_to') is-invalid @enderror" 
                                               id="pickup_date_time_to" name="pickup_date_time_to" value="{{ old('pickup_date_time_to') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('pickup_info') is-invalid @enderror" 
                                       id="pickup_info" name="pickup_info" value="{{ old('pickup_info') }}">
                                @error('pickup_info')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('delivery_company') is-invalid @enderror" 
                                       id="delivery_company" name="delivery_company" value="{{ old('delivery_company') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('delivery_additional_info') is-invalid @enderror" 
                                          id="delivery_additional_info" name="delivery_additional_info" rows="3">{{ old('delivery_additional_info') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.00000001" class="form-control @error('delivery_latitude') is-invalid @enderror" 
                                               id="delivery_latitude" name="delivery_latitude" value="{{ old('delivery_latitude') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.00000001" class="form-control @error('delivery_longitude') is-invalid @enderror" 
                                               id="delivery_longitude" name="delivery_longitude" value="{{ old('delivery_longitude') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control @error('delivery_date_time_from') is-invalid @enderror" 
                                               id="delivery_date_time_from" name="delivery_date_time_from" value="{{ old('delivery_date_time_from') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control @error('delivery_date_time_to') is-invalid @enderror" 
                                               id="delivery_date_time_to" name="delivery_date_time_to" value="{{ old('delivery_date_time_to') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('delivery_info') is-invalid @enderror" 
                                       id="delivery_info" name="delivery_info" value="{{ old('delivery_info') }}">
                                @error('delivery_info')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('job_description') is-invalid @enderror" 
                                       id="job_description" name="job_description" value="{{ old('job_description') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('suggested_vehicle') is-invalid @enderror" 
                                       id="suggested_vehicle" name="suggested_vehicle" value="{{ old('suggested_vehicle') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('packaging') is-invalid @enderror" 
                                       id="packaging" name="packaging" value="{{ old('packaging') }}">
                                @error('packaging')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('no_of_items') is-invalid @enderror" 
                                               id="no_of_items" name="no_of_items" value="{{ old('no_of_items', 1) }}" min="1">
                                        @error('no_of_items')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control @error('gross_weight') is-invalid @enderror" 
                                               id="gross_weight" name="gross_weight" value="{{ old('gross_weight') }}">
                                        @error('gross_weight')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('weight_unit') is-invalid @enderror" 
                                            ...
                                            <option value="kg" {{ old('weight_unit', 'kg') == 'kg' ? 'selected' : '' }}>Kilograms</option>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('body_type') is-invalid @enderror" 
                                               id="body_type" name="body_type" value="{{ old('body_type') }}">
                                        @error('body_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('job_type') is-invalid @enderror" 
                                    ...
                                    <option value="pickup_delivery" {{ old('job_type', 'pickup_delivery') == 'pickup_delivery' ? 'selected' : '' }}>Pickup & Delivery</option>
                                    <option value="courier" {{ old('job_type') == 'courier' ? 'selected' : '' }}>Courier</option>
                                    <option value="freight" {{ old('job_type') == 'freight' ? 'selected' : '' }}>Freight</option>
                                    <option value="moving" {{ old('job_type') == 'moving' ? 'selected' : '' }}>Moving</option>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('dimension_unit') is-invalid @enderror" 
                                            ...
                                            <option value="cm" {{ old('dimension_unit', 'cm') == 'cm' ? 'selected' : '' }}>Centimeters</option>
                                            <option value="inches" {{ old('dimension_unit') == 'inches' ? 'selected' : '' }}>Inches</option>
                                            <option value="meters" {{ old('dimension_unit') == 'meters' ? 'selected' : '' }}>Meters</option>
                                            <option value="feet" {{ old('dimension_unit') == 'feet' ? 'selected' : '' }}>Feet</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control @error('distance_miles') is-invalid @enderror" 
                                               id="distance_miles" name="distance_miles" value="{{ old('distance_miles') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control @error('rate_per_km') is-invalid @enderror" 
                                               id="rate_per_km" name="rate_per_km" value="{{ old('rate_per_km') }}">
                                        @error('rate_per_km')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control @error('rate_per_mile') is-invalid @enderror" 
                                               id="rate_per_mile" name="rate_per_mile" value="{{ old('rate_per_mile') }}">
                                        @error('rate_per_mile')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
