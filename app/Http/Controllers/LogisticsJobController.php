...
class LogisticsJobController extends Controller
{
    public function index(Request $request)
    {
        ...
        elseif ($user->user_type === 'driver') {
            ...
            $jobs = LogisticsJob::whereNull('id');
        }
    ...
    public function show(LogisticsJob $logisticsJob)
    {
        $user = Auth::user();
    ...
    public function destroy(LogisticsJob $logisticsJob)
    {
        if ($logisticsJob->upload_document) {
            Storage::disk('public')->delete($logisticsJob->upload_document);
        }
    ...
    public function assign(Request $request, LogisticsJob $logisticsJob)
    {
        $request->validate([
    ...
    public function accept(LogisticsJob $logisticsJob)
    {
        $user = Auth::user();
    ...
    public function updateStatus(Request $request, LogisticsJob $logisticsJob)
    {
        $request->validate([
            'status' => 'required|in:pending,assigned,in_progress,picked_up,in_transit,delivered,completed,cancelled'
        ]);
