...
class LoadBidController extends Controller
{
    public function index()
    {
        ...
        return view('load-prices.index', compact('prices'));
    }
    ...
    public function create()
    {
        ...
        return view('load-prices.create', compact('logisticsJobs', 'companies'));
    }
    ...
    public function show(LoadBid $loadPrice)
    {
        ...
        if ($user->user_type === 'company' && $loadPrice->company_id !== $user->id) {
            return redirect()->route('load-prices.index')
        ...
        return view('load-prices.show', compact('loadPrice'));
    }
    ...
    public function edit(LoadBid $loadPrice)
    {
        ...
        return view('load-prices.edit', compact('loadPrice', 'logisticsJobs', 'companies'));
    }
    ...
    private function getIndexRoute()
    {
        ...
        return match($user->user_type) {
            'admin' => 'admin.load-prices.index',
            'company' => 'company.load-prices.index',
            'driver' => 'driver.load-prices.index',
            default => 'load-prices.index'
        };
    }
    ...
    private function getCreateRoute()
    {
        $user = Auth::user();
        return match($user->user_type) {
            'admin' => 'admin.load-prices.create',
            'company' => 'company.load-prices.create',
            default => 'load-prices.create'
        };
    }
}
